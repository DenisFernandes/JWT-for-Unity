...
## Installation
The easiest way to install is downloading this repository and placing the JWT on your Unity project

## Dependency
Requires [Newtonsoft Json](https://github.com/JamesNK/Newtonsoft.Json)
